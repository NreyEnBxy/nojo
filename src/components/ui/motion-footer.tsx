...
export function CinematicFooter() {
  ...
  return (
    <>
      ...
      >
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-[#000] text-white cinematic-footer-wrapper pointer-events-auto z-0">
          ...
          <div
            ref={giantTextRef}
            className="footer-giant-bg-text absolute bottom-[30vh] left-1/2 -translate-x-1/2 whitespace-nowrap z-0 pointer-events-none select-none animate-footer-float"
          >
            NOJO
          </div>

          {/* 1. Diagonal Sleek Marquee (Top of footer) */}
          <div className="absolute top-12 left-0 w-full overflow-hidden border-y border-white/5 bg-black/40 backdrop-blur-xl py-5 z-10 -rotate-1 scale-105 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
            <div className="flex w-max animate-footer-scroll-marquee text-xs md:text-sm font-bold tracking-[0.4em] text-white/40 uppercase">
              <MarqueeItem />
              <MarqueeItem />
            </div>
          </div>
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            <h2
              ref={headingRef}
              className="text-6xl md:text-9xl font-black footer-text-glow tracking-tighter mb-16 text-center leading-[0.9]"
            >
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-8 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-5 w-full">
                <MagneticButton as="a" href="#" className="footer-glass-pill px-12 py-6 rounded-full text-white font-bold text-sm md:text-base flex items-center gap-3 group">
              ...
              <div className="flex flex-wrap justify-center gap-4 md:gap-8 w-full mt-4">
                <MagneticButton as="a" href="#" className="footer-glass-pill px-8 py-4 rounded-full text-white/50 font-medium text-xs md:text-sm hover:text-white">
                  Privacy Policy
                </MagneticButton>
                <MagneticButton as="a" href="/terms" className="footer-glass-pill px-8 py-4 rounded-full text-white/50 font-medium text-xs md:text-sm hover:text-white">
                  Terms & Conditions
                </MagneticButton>
                <MagneticButton as="a" href="https://www.supportkori.com/nuet" target="_blank" rel="noopener noreferrer" className="footer-glass-pill px-8 py-4 rounded-full text-white/50 font-medium text-xs md:text-sm hover:text-white">
                  Support
                </MagneticButton>
              </div>
            </div>
          ...
          <div ref={bottomBarRef} className="relative z-20 w-full pb-10 px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-8">
            
            {/* Copyright */}
            <div className="text-white/30 text-[10px] md:text-xs font-semibold tracking-[0.2em] uppercase order-2 md:order-1">
              © 2026 NOJO INT. All rights reserved.
            </div>

            {/* "Made with Love" Badge */}
            <div className="footer-glass-pill px-8 py-4 rounded-full flex items-center gap-3 order-1 md:order-2 cursor-default border-white/5">
              ...
              <span className="text-white font-black text-xs md:text-sm tracking-normal ml-1">NUET</span>
            </div>
            ...
            <MagneticButton
              as="button"
              onClick={scrollToTop}
              className="w-14 h-14 rounded-full footer-glass-pill flex items-center justify-center text-white/50 hover:text-white group order-3 shadow-2xl"
            >
