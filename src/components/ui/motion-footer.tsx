...
export function CinematicFooter() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Set initial state
      gsap.set(giantTextRef.current, { y: "20vh", scale: 0.7, opacity: 0, filter: "blur(30px)" });
      gsap.set([headingRef.current, linksRef.current], { y: 150, opacity: 0, filter: "blur(20px)" });
    ...
    <>
      ...
      */}
      <div
        ...
        style={{ clipPath: "polygon(0% 0, 100% 0%, 100% 100%, 0 100%)", zIndex: 50 }}
      >
