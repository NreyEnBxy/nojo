...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Experience Cold</span> <span className="text-primary/60">✦</span>
    <span>Premium Quality</span> <span className="text-secondary/60">✦</span>
...
export function CinematicFooter() {
  ...
  return (
    <>
      ...
      <footer 
        ref={wrapperRef}
        className="relative min-h-screen w-full flex flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper border-t border-white/5 py-20"
      >
        ...
        <div className="relative w-full overflow-hidden border-y border-border/50 bg-background/60 backdrop-blur-md py-4 z-10 -rotate-2 scale-110 shadow-2xl mb-20">
        ...
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 w-full max-w-5xl mx-auto text-center">
          <h2 ref={headingRef} className="text-5xl md:text-8xl font-black footer-text-glow tracking-tighter mb-12">
            Ready to drink?
          </h2>
          ...
          <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
            ...
            <div className="flex flex-wrap justify-center gap-6 w-full mt-4">
              <MagneticButton as="a" href="#" className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground transition-colors">
                Privacy Policy
              </MagneticButton>
              <MagneticButton as="a" href="#" className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground transition-colors">
                Terms of Service
        ...
        <div className="relative z-20 w-full pb-12 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-8 mt-20">
